...
import img1 from '../../assets/imgs/pages/blog/blog.png'
import img2 from '../../assets/imgs/pages/blog/blog2.png'
import img3 from '../../assets/imgs/pages/blog/blog3.png'
import img4 from '../../assets/imgs/pages/blog/blog4.png'
import img5 from '../../assets/imgs/pages/blog/blog5.png'
import img6 from '../../assets/imgs/pages/blog/blog6.png'
import img7 from '../../assets/imgs/pages/blog/blog7.png'
import img8 from '../../assets/imgs/pages/blog/blog8.png'
import img9 from '../../assets/imgs/pages/blog/blog9.png'
function BlogBox() {
    return (
      <>
       <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                                <a href="news-details.html"><img src={img1} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">IT Solutions That Drive Innovation in Your Business</a>
                                <a href="/blog-d" className="link-more button-ag-bold">
                                    Discover More
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img2} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">From Risk to Resilience: Strengthening IT Security</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                                    </svg>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img3} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Building a Robust IT Ecosystem for Your Enterprise</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img4} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Harnessing the Power of AI in IT Solutions</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img5} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Transforming Small Businesses with IT Automation</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img6} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Navigating the Digital Landscape with Smart IT Solutions</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img7} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Leveraging IT for Competitive Advantage in Business</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            <div className="card-image">
                            <a href="news-details.html"><img src={img8} alt="Vatech" /></a>
                            </div>
                            <div className="card-info">
                                <div className="text-end mb-2">
                                    <span className="post-date sub-heading-ag-sm d-inline-block">Oct 19</span>
                                </div>
                                <a href="news-details.html" className="heading-md">Cloud vs. On-Premise: Which IT Solution is Right for You?</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card-blog-7">
                            ...
                            <div className="card-info">
                                ...
                                <a href="news-details.html" className="heading-md">Maximizing ROI Through Strategic IT Investments</a>
                                <a href="news-details.html" className="link-more button-ag-bold">
                                    Discover More
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.8125 5.75C11.8125 6.24219 11.4023 6.65234 10.9375 6.65234H7V10.5898C7 11.0547 6.58984 11.4375 6.125 11.4375C5.63281 11.4375 5.25 11.0547 5.25 10.5898V6.65234H1.3125C0.820312 6.65234 0.4375 6.24219 0.4375 5.75C0.4375 5.28516 0.820312 4.90234 1.3125 4.90234H5.25V0.964844C5.25 0.472656 5.63281 0.0625 6.125 0.0625C6.58984 0.0625 7 0.472656 7 0.964844V4.90234H10.9375C11.4023 4.875 11.8125 5.28516 11.8125 5.75Z" fill="" />
