                  ...
                  <div className="col-lg-6">
                      <div className="box-image-about-us-2">
                          <div className="image-about-1">
                              <img className="wow img-custom-anim-left" src={`/img/${aboutInfo?.img1}`} alt="Vatech" />
                          </div>
                          <div className="image-about-2">
                              <img className="wow img-custom-anim-right" src={`/img/${aboutInfo?.img2}`} alt="Vatech" />
                          </div>
                      </div>
                  </div>
                  <div className="col-lg-6">
                      <div className="box-info-about-top">
                          <div className="banner-small-title-black line-primary-1400">{aboutInfo?.sub_title}</div>
                          <h2 className="heading-ag-3xl dark-950 mb-3">
                              {aboutInfo?.title}
                          </h2>
                      </div>
                      <div className="box-info-about-line">
                          <p className="mb-20 paragraph-rubik-r neutral-1700"> {aboutInfo?.content}</p>
                          <ul className="list-tick">
                             
                              {aboutInfo?.list && (
                                  <ul className="list-tick">
                                      {aboutInfo.list.split(",").map((item, index) => (
                                          <li key={index} className="sub-heading-ag-sm">
                          ...
                          <Link to={aboutInfo?.button_link} className="btn btn-border-gray-600 mb-3">
                              {aboutInfo?.button_text}
